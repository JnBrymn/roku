...
export const polyhedraData = [
  ...
  { file: '/data/A10egaT.txt', name: 'A10 Exploded Gyro Ambo Tetrahedron', slug: 'A10egaT' },
  { file: '/data/A10egaO.txt', name: 'A10 Exploded Gyro Ambo Octahedron', slug: 'A10egaO' },
  { file: '/data/A10egaC.txt', name: 'A10 Exploded Gyro Ambo Cube', slug: 'A10egaC' },
  { file: '/data/A10egaD.txt', name: 'A10 Exploded Gyro Ambo Dodecahedron', slug: 'A10egaD' },
  { file: '/data/A10egaI.txt', name: 'A10 Exploded Gyro Ambo Icosahedron', slug: 'A10egaI' },
  { file: '/data/A10beC.txt', name: 'A10 Bevel Exploded Cube', slug: 'A10beC' },
  { file: '/data/A10beT.txt', name: 'A10 Bevel Exploded Tetrahedron', slug: 'A10beT' },
  { file: '/data/A10beD.txt', name: 'A10 Bevel Exploded Dodecahedron', slug: 'A10beD' },
  { file: '/data/A10eeC.txt', name: 'A10 Exploded Exploded Cube', slug: 'A10eeC' },
  { file: '/data/A10eeI.txt', name: 'A10 Exploded Exploded Icosahedron', slug: 'A10eeI' },
  { file: '/data/A10ooD.txt', name: 'A10 Ortho Ortho Dodecahedron', slug: 'A10ooD' },
  { file: '/data/A10dooI.txt', name: 'A10 Dual Ortho Ortho Icosahedron', slug: 'A10dooI' },
  { file: '/data/A10ssaaT.txt', name: 'A10 Snub Snub Ambo Ambo Tetrahedron', slug: 'A10ssaaT' }
]
